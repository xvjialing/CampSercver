...
<html lang="en">
    <head>
        <meta charset="UTF-8">
        <title>欢迎您登录E站到赢</title>
        <link rel="stylesheet" type="text/css" href="/onethink1/Public/Admin/css/login.css" media="all">
            ...
            <div class="login-body">
                <div class="login-main pr">
                    <form action="<?php echo U('login');?>" method="post" class="login-form">
                        <h3 class="welcome"><!-- <i class="login-logo"></i> -->E站到赢管理平台</h3>
