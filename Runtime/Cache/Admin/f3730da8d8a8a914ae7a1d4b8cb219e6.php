...
<head>
    <meta charset="UTF-8">
    <title><?php echo ($meta_title); ?>|露营游戏管理平台</title>
    ...
    <div class="cf">
        ...
        <div class="search-form fr cf">
            <div class="sleft">
                ...
                <a class="sch-btn" href="javascript:;" id="search" url="/onethink1/index.php?s=/Admin/PerCenter/yishenhe.html"><i class="btn-search"></i></a>
            </div>
        </div>
    </div>
