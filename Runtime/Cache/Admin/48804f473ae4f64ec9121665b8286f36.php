...
<style type="text/css"> 
   ...
   #container2{
	...
	<!-- <link rel="stylesheet" type="text/css" href="<?php echo (ADMIN_CSS_URL); ?>my.css"> -->
...
<body>
   ...
   <div class="main-title">
       ...
       <div class='mtu' id='tu1'>
          <div id="container" style="min-width: 310px; height: 400px; margin: 0 auto"></div>
       </div>
     <div class="main-title">
        <h2>代理下营地中各游戏类型订单量比例</h2>
    </div>    
       <div id="chartdiv"></div>      
...
<!--     <script type="text/javascript" src="/onethink1/Public/Admin/js/common.js"></script> -->
    <script type="text/javascript">
     ...
     <script src="<?php echo (ADMIN_JS_URL); ?>exporting.js"></script> 
	<script type="text/javascript" src="<?php echo (ADMIN_JS_URL); ?>grouped-categories.js"></script>

    <script type="text/javascript" src="<?php echo (ADMIN_JS_URL); ?>jquery1101.js"></script>
    <script type="text/javascript" src="<?php echo (ADMIN_JS_URL); ?>highcharts.js"></script>
    	
  <script type="text/javascript" src="<?php echo (ADMIN_JS_URL); ?>my.js"></script> 
