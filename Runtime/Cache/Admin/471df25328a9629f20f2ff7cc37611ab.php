...
<body>
    ...
    <div class="cf">
        <a class="btn" href="<?php echo U('gadd',array('campID'=>I('get.campID',0)));?>">新 增</a>
        ...
        <div class="search-form fr cf">
            <div class="sleft">
                ...
                <a class="sch-btn" href="javascript:;" id="search" url="/onethink1/index.php?s=/Admin/Game/glist.html"><i class="btn-search"></i></a>
            </div>
        </div>
    </div>
        ...
        <form class="ids">
            <table>
				...
				<?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$camp): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td><?php echo ($camp["campID"]); ?></td>
                        <td>
                            <a href="<?php echo U('detail?campID='.$camp['campID']);?>"><?php echo ($camp["campName"]); ?></a>
                        </td>
                        <td><?php echo ($camp["bivName"]); ?></td>
                        <td>3</td>
                        <td><?php echo ($camp["campHot"]); ?></td>
                        <td>
                        ...
                        <td>
                            <a title="编辑" href="<?php echo U('gupdate?campID='.$camp['campID']);?>">编辑</a>
                            <a class="confirm ajax-get" title="删除" href="<?php echo U('gdelete?campID='.$camp['campID']);?>">删除</a>
                        </td>
