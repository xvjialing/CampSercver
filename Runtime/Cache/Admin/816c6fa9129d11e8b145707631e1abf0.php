...
<body>
	...
	<!-- 标题栏 -->
		...
		<li class="current"><a href="<?php echo U('updateXinxi');?>">完善信息</a></li>
		</ul>
		<div class="tab-content">
	<!-- 修改密码表单 -->
     <form action="<?php echo U(User/updateXinxi);?>" method="post" class="form-horizontal">
		
		<div class="form-item">
			<label class="item-label">联系方式：<span class="check-tips">（请输入联系方式）</span></label>
			<div class="controls">
				<input type="text" name="mobile" class="text input-large"  value="<?php echo ($info["mobile"]); ?>"/>
			</div>
		</div>
		<div class="form-item">
			<label class="item-label">身份证号：<span class="check-tips">（请输入身份证号）</span></label>
			<div class="controls">
				<input type="text" name="identity" class="text input-large"  value="<?php echo ($info["identity"]); ?>"/>
			</div>
		</div>
		<div class="form-item">
			<label class="item-label">地址：<span class="check-tips">（请输入所在详细地址）</span></label>
			<div class="controls">
				<input type="text" name="userAdd" class="text input-large" value="<?php echo ($info["userAdd"]); ?>"/>
			</div>
		</div>
		<div class="form-item">
