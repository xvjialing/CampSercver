    ...
    <div class="cf">
        ...
        <div class="search-form fr cf">
            <div class="sleft">
                ...
                <a class="sch-btn" href="javascript:;" id="search" url="/onethink1/index.php?s=/Admin/PerCenter/bivouac.html"><i class="btn-search"></i></a>
            </div>
        </div>
    </div>
        ...
        <form class="ids">
            <table>
				...
				<?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$camp): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td>
                            <a title="审核" href="<?php echo U('bivdetail?bivouacID='.$camp['bivouacID']);?>">审核</a>
