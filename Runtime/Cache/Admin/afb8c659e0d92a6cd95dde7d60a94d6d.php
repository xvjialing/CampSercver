    ...
    <div class="cf">
        ...
        <div class="search-form fr cf">
            <div class="sleft">
                ...
                <a class="sch-btn" href="javascript:;" id="search" url="/onethink1/index.php?s=/Admin/Sale/order.html"><i class="btn-search"></i></a>
            </div>
        </div>
    </div>
    ...
    <div class="data-table table-striped">
        <form class="ids">
            <table>
                ...
                <tbody>
				<?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$order): $mod = ($i % 2 );++$i;?><tr>
                        <td><input class="ids row-selected" type="checkbox" name="orderID[]" value="<?php echo ($order["orderID"]); ?>"></td>
                        <td><?php echo ($order["orderID"]); ?></td>
                        <td><?php echo ($order["bivName"]); ?></td>
                        <td><?php echo ($order["teamName"]); ?></td>
                        <td><?php echo ($order["sum"]); ?></td>
                        <td>8</td>
                        <td><?php echo ($order["amount"]); ?></td>                                         
                        <td>
                            <a title="查看详情" href="<?php echo U('detail?orderID='.$order['orderID']);?>">查看详情</a>
                            <a class="confirm ajax-get" title="删除" href="<?php echo U('delete?orderID='.$order['orderID']);?>">删除</a>
                        </td>
