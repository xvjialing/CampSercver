...
<body>
    ...
    <div class="cf">
        <a class="btn" href="<?php echo U('add',array('bivouacID'=>I('get.bivouacID',0)));?>">新 增</a>
        ...
        <div class="search-form fr cf">
            <div class="sleft">
                ...
                <a class="sch-btn" href="javascript:;" id="search" url="/onethink1/index.php?s=/Admin/PerCenter/camp.html"><i class="btn-search"></i></a>
            </div>
        </div>
    </div>
        ...
        <form class="ids">
            <table>
				...
				<?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$camp): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td>
                            <a href="<?php echo U('camp?bivouacID='.$camp['bivouacID']);?>"><?php echo ($camp["campName"]); ?></a>
                        </td>
                        <td><?php echo ($camp["bivName"]); ?></td>
                        ...
                        <td>
                            <a title="审核" href="<?php echo U('cdetail?campID='.$camp['campID']);?>">审核</a>
                            <a class="confirm ajax-get" title="删除" href="<?php echo U('del?bivouacID='.$camp['bivouacID']);?>">删除</a>
                        </td>
...
<!--     <script type="text/javascript" src="/onethink1/Public/Admin/js/common.js"></script> -->
    ...
    <script type="text/javascript">
        $(function() {
            ...
            //导航高亮
            highlight_subnav('<?php echo U('camp');?>');
            //点击排序
